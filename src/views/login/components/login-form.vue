<template>
  <div class="login-form">
    ...
    >
      ...
      >
        <a-input v-model="form.username" :placeholder="t('login.form.userName.placeholder')">
          <template #prefix>
            <icon-user />
          </template>
        </a-input>
      ...
      >
        <a-space>
          <a-input v-model="form.captchaCode" :placeholder="t('login.form.captcha.placeholder')">
            <template #prefix>
              <icon-safe />
            </template>
          </a-input>
