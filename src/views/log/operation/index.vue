    ...
    <a-card class="general-card" :title="t('log.operation.title')">
          ...
          >
            <a-row :gutter="16">
              ...
              <a-col :span="8">
                <a-form-item
                  field="module"
                  :label="t('log.operation.form.module')"
                >
                  <a-input
              ...
              <a-col :span="8">
                <a-form-item
                  field="action"
                  :label="t('log.operation.form.action')"
                >
                  <a-input
      ...
      >
        <template #columns>
          ...
          />
          <a-table-column
            :title="t('log.operation.columns.module')"
            data-index="module"
          />
          <a-table-column
            :title="t('log.operation.columns.action')"
            data-index="action"
          />
          <a-table-column
            :title="t('log.operation.columns.method')"
            data-index="method"
          />
          <a-table-column
            :title="t('log.operation.columns.path')"
            data-index="path"
          />
          <a-table-column :title="t('log.columns.ip')" data-index="ip" />
          <a-table-column
            :title="t('log.operation.columns.duration')"
            data-index="duration"
          >
          ...
          <a-table-column
            :title="t('log.operation.columns.createdAt')"
