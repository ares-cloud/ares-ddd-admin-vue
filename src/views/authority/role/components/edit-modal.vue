<template>
  <a-modal :visible="visible" :title="title" @ok="handleOk" @cancel="handleCancel">
    ...
    >
      ...
      <a-form-item field="localize" :label="t('authority.role.searchTable.columns.localize')">
        <a-input
          v-model="form.localize"
          :placeholder="t('authority.role.searchTable.form.localize.placeholder')"
        />
      </a-form-item>
...
const title = computed(() =>
  form.id ? t('authority.role.modal.title.edit') : t('authority.role.modal.title.create')
);
